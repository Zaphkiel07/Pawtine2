  ...
  const pricingPlans = [
    {
      ...
      monthlyPrice: "$0",
      annualPrice: "$0",
      description: "Begin with the essentials for one dog and one caregiver.",
      features: [
        "AI reminders for meals, walks, and hydration",
    ...
    },
    {
      ...
      monthlyPrice: "$18",
      annualPrice: "$15",
      description: "Great for busy households or pet sitters caring for multiple pups.",
      features: [
        "Unlimited caregivers",
        "Multi-dog routine management",
        "Smart calendar syncing",
        "Advanced insights & wellness trends",
    ...
    },
    {
      ...
      monthlyPrice: "$48",
      annualPrice: "$42",
      description: "For professional walkers, kennels, and concierge pet care teams.",
      features: [
        "Dedicated onboarding specialist",
        "Custom automation recipes",
        "Vet & trainer collaboration portals",
        "API access and integrations",
        "White-labeled caregiver reports",
      ],
      ...
      <div className="self-stretch relative flex flex-col justify-center items-center gap-2 py-0">
        <div className="flex flex-col justify-start items-center gap-4">
          <h2 className="text-center text-foreground text-4xl md:text-5xl font-semibold leading-tight md:leading-[40px]">
            Pricing designed for every pack
          </h2>
          <p className="self-stretch text-center text-muted-foreground text-sm font-medium leading-tight">
            Choose the routine support that fits your lifestyle — from first-time pup parents to professional caregivers.
          </p>
        </div>
        <div className="pt-4">
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-6">
              ...
              >
                <div className="px-1.5 flex justify-center items-center gap-2">
                  <span
                    className={`text-center text-sm font-medium leading-tight ${plan.name === "Starter" ? "text-gray-800" : plan.name === "Plus" ? "text-primary" : "text-zinc-950"}`}
                  >
                    {plan.buttonText}
                  </span>
                </div>
